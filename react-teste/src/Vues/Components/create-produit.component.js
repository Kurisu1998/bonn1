...
export default class CreateProduit extends Component {
  ...
  onSubmit(e) {
    ...
    axios.post('http://localhost:5000/produit/add', exercise)
    ...
    return (
      <div>
        ...
        <form onSubmit={this.onSubmit}>
          ...
          <div className="form-group">
            <input type="submit" value="Créer un produit" className="btn btn-primary" />
          </div>
        </form>
      </div>
    )
